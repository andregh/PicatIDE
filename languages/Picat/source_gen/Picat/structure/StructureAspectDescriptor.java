...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      case 0:
        return new ConceptDescriptorBuilder("Picat.structure.Argument").super_("Picat.structure.PicatConcept").parents("Picat.structure.PicatConcept").abstract_().create();
      case 1:
        return new ConceptDescriptorBuilder("Picat.structure.Atom").super_("Picat.structure.Term").parents("Picat.structure.Term").create();
      case 2:
        return new ConceptDescriptorBuilder("Picat.structure.Body").super_("Picat.structure.PicatConcept").parents("Picat.structure.PicatConcept").abstract_().create();
      case 3:
      ...
      case 5:
        return new ConceptDescriptorBuilder("Picat.structure.Condition").super_("Picat.structure.Goal").parents("Picat.structure.Goal").abstract_().create();
      case 6:
        return new ConceptDescriptorBuilder("Picat.structure.DisjunctiveGoal").super_("Picat.structure.PicatConcept").parents("Picat.structure.PicatConcept").abstract_().create();
      case 7:
      ...
      case 8:
        return new ConceptDescriptorBuilder("Picat.structure.Expression").super_("Picat.structure.PicatConcept").parents("Picat.structure.PicatConcept").create();
      case 9:
      ...
      case 14:
        return new ConceptDescriptorBuilder("Picat.structure.FunctionRuleOrFact").super_("Picat.structure.PicatConcept").parents("Picat.structure.PicatConcept").children(new String[]{"head"}, new boolean[]{false}).abstract_().create();
      case 15:
      ...
      case 16:
        return new ConceptDescriptorBuilder("Picat.structure.Goal").super_("Picat.structure.PicatConcept").parents("Picat.structure.PicatConcept").abstract_().create();
      case 17:
      ...
      case 21:
        return new ConceptDescriptorBuilder("Picat.structure.NegativeGoal").super_("Picat.structure.PicatConcept").parents("Picat.structure.PicatConcept").create();
      case 22:
