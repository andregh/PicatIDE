...
public class Root_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_30aiet_b0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Root_Editor.conceptsListHandler_30aiet_b0(node, "concepts", editorContext);
  ...
  private static class conceptsListHandler_30aiet_b0 extends RefNodeListHandler {
    public conceptsListHandler_30aiet_b0(SNode ownerNode, String childRole, EditorContext context) {
    ...
    public EditorCell createEmptyCell_internal(EditorContext editorContext, SNode node) {
      return this.createConstant_30aiet_a1a(editorContext, node);
    }
    ...
    private EditorCell createConstant_30aiet_a1a(EditorContext editorContext, SNode node) {
      EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "");
      editorCell.setCellId("Constant_30aiet_a1a");
